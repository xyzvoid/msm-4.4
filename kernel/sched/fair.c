 ...
 */
unsigned int sysctl_sched_wakeup_granularity = 500000UL; /* 0.5ms — lower = faster UI thread wakeup */
unsigned int normalized_sysctl_sched_wakeup_granularity = 500000UL; /* 0.5ms — lower = faster UI thread wakeup */
